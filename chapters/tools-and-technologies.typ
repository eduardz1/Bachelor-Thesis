...
#_content(
  [
    ...
    For example the following query will return the last moisture measurement:
    ...
    As introduced previously, `SMOL` is an OO programming language in its early developement stages, it allows us to:
